...
[Serializable]
[Title("Master", "ToonPBR")]
public class CustomPBRNode : MasterNode<ICustomPBRSubShader>, IMayRequireNormal
{
    ...
    public const string FresnelTintName = "FresnelTint";
    public const string FresnelStengthName = "FresnelStrength";
    public const string FresnelPowerName = "FresnelPower";
    public const string FresnelContributionName = "FresnelContribution";
    public const string TransmissionName = "Transmission";
    ...
    public const int FresnelTintSlotId = 9;
    public const int FresnelStengthSlotId = 10;
    public const int FresnelPowerSlotId = 11;
    public const int FresnelContributionSlotId = 12;
    public const int TransmissionSlotId = 13;
    ...
    [SerializeField]
    private bool _Fresnel;

    [ToggleControl("Fresnel")]
    public Toggle fresnel
    {
        get { return new Toggle(_Fresnel); }
        set
        {
            if (_Fresnel == value.isOn)
                return;
            _Fresnel = value.isOn;
            Dirty(ModificationScope.Graph);
        }
    ...
    public sealed override void UpdateNodeAfterDeserialization()
    {
        ...
        AddSlot(new ColorRGBMaterialSlot(FresnelTintSlotId, FresnelTintName, FresnelTintName, SlotType.Input, Color.black, ShaderStage.Fragment));
        AddSlot(new Vector1MaterialSlot(FresnelStengthSlotId, FresnelStengthName, FresnelStengthName, SlotType.Input, 0f, ShaderStage.Fragment));
        AddSlot(new Vector1MaterialSlot(FresnelPowerSlotId, FresnelPowerName, FresnelPowerName, SlotType.Input, 0f, ShaderStage.Fragment));
        AddSlot(new Vector1MaterialSlot(FresnelContributionSlotId, FresnelContributionName, FresnelContributionName, SlotType.Input, 0f, ShaderStage.Fragment));
        AddSlot(new Vector1MaterialSlot(TransmissionSlotId, TransmissionName, TransmissionName, SlotType.Input, 0f, ShaderStage.Fragment));
            ...
            new[]
        {
            ...
            FresnelTintSlotId,
            FresnelStengthSlotId,
            FresnelPowerSlotId,
            FresnelContributionSlotId,
            TransmissionSlotId,
        }, true);
    }
